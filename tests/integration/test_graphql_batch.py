...
class TestGraphQLFeatureFlagFallback:
    ...
    def test_feature_flag_disabled_uses_rest(self):
        """Test that disabling GraphQL flag falls back to REST API."""
        # When USE_GRAPHQL_BATCH is False, should use REST API
        import os
        ...
        with patch.dict(
            ...
            assert not config.use_graphql_batch

    def test_feature_flag_enabled_uses_graphql(self):
        """Test that enabling GraphQL flag uses GraphQL API."""
        import os
        from unittest.mock import patch
        ...
        with patch.dict(
            ...
            assert config.use_graphql_batch
